...
bucket = 'encryption-client-example-etnard'
file = 'file.txt'
...
s3.put_object(bucket:bucket, key:file, body:'handshake')
s3.get_object(bucket:bucket, key:file).body.read
#=> 'handshake'

# reading encrypted object without the encryption client
# results in the getting the cipher text
Aws::S3::Client.new.get_object(bucket:bucket, key:file).body.read
#=> "... cipher text ..."